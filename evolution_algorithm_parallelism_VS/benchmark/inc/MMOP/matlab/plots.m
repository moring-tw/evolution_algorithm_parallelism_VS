...
exportgraphics(fig,'AnnotatedPlot.png', 'Resolution', '300')
...
surfc(x,y,f,'FaceColor','interp','FaceLighting','phong','EdgeColor','none','FaceAlpha', 0.3);
grid off;
hold on;
view([-90 90])
p_num = 41;
