...
double CEC2013::compute(double* x) {
	//	Due to the need of unifying the all problems as minimum problems, it is modified to return sign changed value
	return 0 - CEC2013::evaluate(x);
}
...
void CEC2013::load_goptima()
{
	...
	std::string base = "benchmark/inc/MMOP/";
	std::string filename;
	if (nfunc_ == 1) {
		filename = base + "data/F1_opt.dat";
	}
	else if (nfunc_ == 2) {
		filename = base + "data/F2_opt.dat";
	}
	else if (nfunc_ == 3) {
		filename = base + "data/F3_opt.dat";
	}
	else if (nfunc_ == 4) {
		filename = base + "data/F4_opt.dat";
	}
	else if (nfunc_ == 5) {
		filename = base + "data/F5_opt.dat";
	}
	else if (nfunc_ == 6) {
		filename = base + "data/F6_2D_opt.dat";
	}
	else if (nfunc_ == 8) {
		filename = base + "data/F6_3D_opt.dat";
	}
	else if (nfunc_ == 7) {
		filename = base + "data/F7_2D_opt.dat";
	}
	else if (nfunc_ == 9) {
		filename = base + "data/F7_3D_opt.dat";
	}
	else if (nfunc_ == 10) {
		filename = base + "data/F8_2D_opt.dat";
	}
